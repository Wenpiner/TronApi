...
enum class ContractType(val str: String, val clazz: Class<*>) {
            AccountCreateContract("type.googleapis.com/protocol.AccountCreateContract", com.github.phish.tron.block.data.transaction.contract.BeanAccountCreateContract::class.java),
    TransferContract("type.googleapis.com/protocol.TransferContract", com.github.phish.tron.block.data.transaction.contract.BeanTransferContract::class.java),

    TransferAssetContract("type.googleapis.com/protocol.TransferAssetContract", com.github.phish.tron.block.data.transaction.contract.BeanTransferAssetContract::class.java),
    ...
    AssetIssueContract("type.googleapis.com/protocol.AssetIssueContract", com.github.phish.tron.block.data.transaction.contract.BeanAssetIssueContract::class.java),
    ...
    ParticipateAssetIssueContract(
        ...
        com.github.phish.tron.block.data.transaction.contract.BeanParticipateAssetIssueContract::class.java
    ),
    AccountUpdateContract("type.googleapis.com/protocol.AccountUpdateContract", com.github.phish.tron.block.data.transaction.contract.BeanAccountUpdateContract::class.java),
    FreezeBalanceContract("type.googleapis.com/protocol.FreezeBalanceContract", com.github.phish.tron.block.data.transaction.contract.BeanFreezeBalanceContract::class.java),
    ...
    ProposalCreateContract(
        ...
        com.github.phish.tron.block.data.transaction.contract.BeanProposalCreateContract::class.java
    ),
    ProposalApproveContract(
        "type.googleapis.com/protocol.ProposalApproveContract",
        com.github.phish.tron.block.data.transaction.contract.BeanProposalApproveContract::class.java
    ),
    ProposalDeleteContract(
        "type.googleapis.com/protocol.ProposalDeleteContract",
        com.github.phish.tron.block.data.transaction.contract.BeanProposalDeleteContract::class.java
    ),

    SetAccountIdContract("type.googleapis.com/protocol.SetAccountIdContract", com.github.phish.tron.block.data.transaction.contract.BeanSetAccountIdContract::class.java),

//        CustomContract("type.googleapis.com/protocol.CustomContract", BeanCustomContract::class.java),
    CreateSmartContract("type.googleapis.com/protocol.CreateSmartContract", com.github.phish.tron.block.data.transaction.contract.BeanCreateSmartContract::class.java),
    TriggerSmartContract("type.googleapis.com/protocol.TriggerSmartContract", com.github.phish.tron.block.data.transaction.contract.BeanTriggerSmartContract::class.java),
...
//    WithdrawExpireUnfreezeContract("type.googleapis.com/protocol.WithdrawExpireUnfreezeContract", BeanWithdrawExpireUnfreezeContract::class.java),
    DelegateResourceContract(
        ...
        com.github.phish.tron.block.data.transaction.contract.BeanDelegateResourceContract::class.java
    ),
